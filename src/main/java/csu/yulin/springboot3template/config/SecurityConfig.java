...
import csu.yulin.springboot3template.common.handler.MyAccessDeniedHandler;
import csu.yulin.springboot3template.common.handler.MyEntryPoint;
import csu.yulin.springboot3template.filter.JwtAuthenticationTokenFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .exceptionHandling(conf -> {
                    conf.authenticationEntryPoint(myEntryPoint);
